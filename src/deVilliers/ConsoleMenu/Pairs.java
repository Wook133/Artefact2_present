...
public class Pairs<K, V> {
    ...
    /**
     * Retrieves the entire key/value pair by index.
     *
     * @param index The index of the pair in the {@link ArrayList}
     * @return {@link Pair}
     */
    ...
    /**
     * Returns the number of pairs in this Pairs collection
     * @return the size of the pairs {@link ArrayList}.
     */
    public int size() {
        return pairs.size();
    }
